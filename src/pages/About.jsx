  ...
  return (
    <section className="section-class">
      ...
      <ul>
        ...
        <li>
          To conduct research on alternative medicine and promote food security.
        </li>
        <li>
      ...
      <p>
        ...
        Drawing from ancient Vedic knowledge, we integrate this with scientific
        advancements to foster holistic well-being and a sustainable lifestyle.
        Our philosophy embodies the idea of Poorna Poshanam — complete
        nourishment.
      </p>
      ...
      <p>
        ...
        evolved from a vision established in 2019. It was inspired by the desire
        to bridge the gap between ancient Vedic wisdom and modern science, with
        a focus on improving nutritional practices and spiritual growth. The
        foundation is dedicated to bringing about lasting positive changes
